...
const AppointmentsHistory = () => {
    ...
    return (
        ...
        >
            <h1 className="text-4xl font-bold mb-8 text-gray-800 border-b pb-4">Appointment History</h1>
                    ...
                    >
                        <div className="p-6">
                            <div className="flex justify-between items-start">
                                <div>
                                    <h2 className="text-xl font-bold text-gray-900 mb-1">Patient: {appointment.patientName}</h2>
                                </div>
