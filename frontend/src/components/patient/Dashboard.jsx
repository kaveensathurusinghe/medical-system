...
const Dashboard = () => {
    ...
    return (
        ...
        >
            <h1 className="text-4xl font-bold mb-8 text-gray-800">Patient's Dashboard</h1>
            ...
            >
                ...
                <StatCard icon={<List size={24} className="text-white"/>} label="Total Appointments" value={stats.totalAppointments} color="bg-green-500" />
                <StatCard icon={<FileText size={24} className="text-white"/>} label="Medical Records" value={stats.medicalRecordsCount} color="bg-indigo-500" />
            </motion.div>
                    ...
                    <ul className="divide-y divide-gray-200">
                        {recentAppointments.length > 0 ? recentAppointments.map(app => (
                            <li key={app.appointmentId} className="p-4 flex justify-between items-center hover:bg-gray-50 transition-colors">
                                <div>
                                    <p className="font-semibold text-gray-800">Dr. {app.doctorName}</p>
