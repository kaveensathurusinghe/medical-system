...
const Appointments = () => {
    ...
    return (
        ...
        >
            <h1 className="text-4xl font-bold mb-8 text-gray-800 border-b pb-4">Manage Appointments</h1>
                ...
                {appointments.map(appointment => (
                    ...
                    >
                        <div className="p-6">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <p className="text-md text-gray-700">with <span className="font-semibold">{appointment.patientName}</span></p>
                                </div>
                        ...
                        <div className="bg-gray-50 px-6 py-3 flex justify-end items-center">
                            <p className="text-sm text-gray-500">Appointment #{appointment.appointmentId}</p>
                        </div>
                    </motion.div>
                ))}
            </motion.div>
